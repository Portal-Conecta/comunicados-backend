...
- Todo PR que faça merge na `main` ou `develop` precisa obrigatoriamente passar pelo Code Review de um Tech Lead e pelo Squad de comunicados para validação de consistência;
