...
public class PinAnnouncementUseCase {
    ...
    @Transactional
    public Announcement execute(PinAnnouncementCommand command) {
        ...
        if (command.pinnedOrder() != null) {
            announcement.setPinnedOrder(command.pinnedOrder().shortValue());
        }
